...
import { RefreshCw, Search, X, ImageIcon, Clock, Building2, Loader2, MessageSquare, ExternalLink, ClipboardList, Sunrise, CheckCircle2, Film, Trash2 } from "lucide-react";
  ...
  return (
    <div className="-m-4 sm:-m-6 lg:-m-8 min-h-[calc(100vh-4rem)] bg-slate-50 pb-16">
      ...
      <div className="p-4 space-y-4">
        ...
        {(me?.isAdmin || me?.isGestor) && <TarefasExtrasHistoricoCard />}
