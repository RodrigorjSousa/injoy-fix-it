...
const SERVICOS: Servico[] = [
  ...
  },
  {
    key: "recepcao",
    label: "Recepção",
    desc: "Atendimento a hóspedes, check-in/out, informações e solicitações gerais.",
    icon: ConciergeBell,
    to: "/painel",
    search: { categoria: "Recepção" },
    tone: "from-purple-500/15 to-purple-500/0 text-purple-600 border-purple-500/30",
    dot: "bg-purple-500",
    btn: "bg-purple-500 hover:bg-purple-600 focus-visible:ring-purple-500 active:bg-purple-700 text-white",
    categoria: "Recepção",
  },
  {
    key: "camareiras",
    label: "Camareiras",
    desc: "Limpeza e organização de quartos, reposição de itens e arrumação.",
    icon: BedDouble,
    to: "/painel",
    search: { categoria: "Camareiras" },
    ...
    categoria: "Camareiras",
  },
  {
    key: "manutencao-geral",
    label: "Manutenção Geral",
    desc: "Reparos diversos, pequenos consertos e suporte técnico geral.",
    icon: Cog,
    to: "/painel",
    search: { categoria: "Manutenção Geral" },
    tone: "from-slate-500/15 to-slate-500/0 text-slate-700 border-slate-500/30",
    dot: "bg-slate-600",
    btn: "bg-slate-600 hover:bg-slate-700 focus-visible:ring-slate-600 active:bg-slate-800 text-white",
  ...
  },
  {
    ...
    label: "Preventiva AC",
    sub: "PMOC",
    desc: "Manutenção preventiva de sistemas de ar condicionado, limpeza e verificações.",
    icon: CalendarCheck,
    to: "/preventiva",
    search: {},
    tone: "from-teal-500/15 to-teal-500/0 text-teal-600 border-teal-500/30",
    dot: "bg-teal-500",
    btn: "bg-teal-500 hover:bg-teal-600 focus-visible:ring-teal-500 active:bg-teal-700 text-white",
    categoria: "Preventiva AC",
  },
];
