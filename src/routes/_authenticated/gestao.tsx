...
import { ArrowUpRight, TrendingUp, Building2, RefreshCw, ClipboardList, ShieldCheck, RefreshCcw, Clock, Wrench, Banknote } from "lucide-react";
  ...
  return (
    <div className="-m-4 sm:-m-6 lg:-m-8 min-h-[calc(100vh-4rem)] bg-slate-50 font-sans antialiased pb-12">
      ...
      <div className="p-4 space-y-6">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 grid place-items-center text-white shadow-sm">
              <ClipboardList className="h-5 w-5" />
            </div>
            <div>
              <p className="text-sm font-black text-slate-900">Histórico de Produção de Limpeza</p>
              <p className="text-xs text-slate-500">Relatório cumulativo das camareiras (filtros por dia, mês, ano, unidade)</p>
            </div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-slate-400" />
        </Link>
        ...
        <Link
          ...
          className="flex items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:border-teal-500 transition-colors"
        >
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-teal-500 to-teal-700 grid place-items-center text-white shadow-sm">
              <Wrench className="h-5 w-5" />
            </div>
            <div>
              <p className="text-sm font-black text-slate-900">Histórico de Produção de Manutenção</p>
              <p className="text-xs text-slate-500">Tarefas preventivas executadas e painel de pendências (atrasadas / próximos 7 dias)</p>
            </div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-slate-400" />
        </Link>
        ...
        >
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 grid place-items-center text-white shadow-sm">
              <ShieldCheck className="h-5 w-5" />
            </div>
            <div>
              <p className="text-sm font-black text-slate-900">Histórico de Vistorias da Recepção</p>
              <p className="text-xs text-slate-500">Checklist, foto e nome da recepcionista de cada vistoria</p>
            </div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-slate-400" />
        </Link>
        ...
        <Link
          to="/historico-caixa"
          className="flex items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:border-emerald-500 transition-colors"
        >
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-emerald-500 to-green-700 grid place-items-center text-white shadow-sm">
              <Banknote className="h-5 w-5" />
            </div>
            <div>
              <p className="text-sm font-black text-slate-900">Histórico de Dinheiro do Caixa</p>
              <p className="text-xs text-slate-500">Relatório de gastos de emergência e reposições da recepção</p>
            </div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-slate-400" />
        </Link>
        ...
        >
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-700 grid place-items-center text-white shadow-sm">
              <RefreshCcw className="h-5 w-5" />
            </div>
            <div>
              <p className="text-sm font-black text-slate-900">Relatórios de Turno da Recepção</p>
              <p className="text-xs text-slate-500">Passagens de serviço · filtros diário/mensal/anual · CSV e impressão</p>
            </div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-slate-400" />
        </Link>
