...
export function PontoFuncionariosModal({
  open,
  onOpenChange,
  unidade,
}: {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden p-0 gap-0 bg-slate-950 border-slate-800 text-slate-100">
        <DialogHeader className="px-6 pt-6 pb-4 border-b border-slate-800 bg-gradient-to-br from-blue-950 to-slate-950">
